...
var target = 'https://core-unitedvision.whelastic.net/tvkabel/api';
...
var errorMessage = function (jqXHR, textStatus, errorThrown) {
    alert('Tidak bisa terkoneksi ke server. Coba beberapa saat lagi!');
}
// Default callback
...
function login(username, password) {
	...
	process(target + '/login', data, 'POST', onSuccessLogin, errorMessage);
}
function logout() {
